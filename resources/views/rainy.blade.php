...
<body>
    ...
    <form class="modal-content animate" action="{{route('rainy-day.store')}}" method="post">
        @csrf
        ...
        <label for="marjors"><b>Nganh hoc</b></label>
        <input type="text" name="marjors" id="" placeholder="Nhap nganh hoc" required>

        <label for="year"><b>Nam hoc</b></label>
        <input type="number" name="year" id="" placeholder="Nhap nam hoc" required>

        <label for="phone"><b>So dien thoai</b></label>
        <input type="text" name="phone" id="" placeholder="Nhap so dien thoai" required>
